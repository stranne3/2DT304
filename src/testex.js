...
app.get("/images/esp32BG.png", function(req, res) {
    res.sendFile(__dirname + "/images/esp32BG.png")
})

app.get("/images/teleborg.jpg", function(req, res) {
    res.sendFile(__dirname + "/images/teleborg.jpg")
})
...
app.get("/firebaseData.csv", function(req, res) {
    console.log(req.url)
    res.sendFile(__dirname + "/firebaseData.csv")
})
...
app.get("/setChart.js", function(req,res){
    res.sendFile
})
...
app.get("/getDataFromFirebase.js", function(req,res){
    res.sendFile
})
