...
static const u1_t DEVEUI[8] = {0x4C, 0x75, 0x25, 0xC2, 0x85, 0x1C, 0xFE, 0xFF};

static const u1_t APPEUI[8] = {0x70, 0xB3, 0xD5, 0x00, 0x00, 0x00, 0x00, 0x00};

static const u1_t APPKEY[16] = {0xBB, 0x85, 0xA6, 0xA3, 0x0E, 0xD4, 0x2E, 0x3D, 0x37, 0xE1, 0xFE, 0x02, 0x0C, 0x54, 0x22, 0x51};
